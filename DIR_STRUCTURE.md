./
├── [L:   0] DIR_STRUCTURE.md
├── examples/
│   ├── agents/
│   │   └── [L:  72] debate.py
│   ├── [L: 140] bash_node_example.py
│   ├── core_only/
│   │   ├── [L: 109] graph_execution.py
│   │   ├── [L:  63] multi_session.py
│   │   ├── [L:  57] simple_session.py
│   │   └── [L:  51] streaming.py
│   ├── [L: 312] debate.py
│   ├── [L: 237] demo_proxy.py
│   ├── [L: 585] dev_coach.py
│   ├── [L: 572] dev_coach_architecture.py
│   ├── [L: 656] dev_coach_consultants.py
│   ├── [L: 734] dev_coach_review.py
│   ├── embedded/
│   │   └── [L:  86] in_process.py
...
│   │   │   ├── [L: 518] test_graph.py
│   │   │   ├── [L: 115] test_policies.py
│   │   │   ├── [L: 919] test_terminal.py
│   │   │   └── [L: 317] test_trace.py
│   │   ├── session/
│   │   │   ├── [L:   0] __init__.py
│   │   │   └── [L: 254] test_session_factory.py
│   │   ├── [L: 549] test_history.py
│   │   ├── [L: 406] test_managers.py
