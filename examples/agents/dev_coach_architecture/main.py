#!/usr/bin/env python3
"""Dev + Coach architecture review collaboration DAG template.
...
Usage:
    python -m examples.agents.dev_coach_architecture.main [server_name] [transport] [context_file]
    python -m examples.agents.dev_coach_architecture.main my-task unix
    python -m examples.agents.dev_coach_architecture.main my-task unix /path/to/context.md
"""
